  ...
  <div class="vue-world-map">
    ...
    >
      ...
      <div class="vue-map-legend-content">
        <div v-if="typeof countryData[legend.code] === 'object'">
          <span>Confirmados: <b>{{countryData[legend.code][0] || 0}}</b></span>
          <span>Mortes: <b>{{countryData[legend.code][1] || 0}}</b></span>
          <span>Suspeitas: <b>{{countryData[legend.code][2] || 0}}</b></span>
        </div>
        <div v-else>
